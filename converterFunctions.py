...
def convert_rna_decorator_5_3(func): 
    ...
    """
       This convert_rna_decorator_5_3 function takes two parameters from
       the original function; the mRNA template strand with a 5 to 3 directionality
    ...
    Args:
        ...
        the rna_template_strand, and the amino acid sequence.
    ...
    def wrapper(*args, **kwargs):
        ...
        print("Amino Acid Sequence: " + func(*args, **kwargs)[2])
        return "Program Status: Done"
...
def convert_rna_5_3(rna_template_strand):
    ...
    match_obj = tRNA_pattern.finditer(complete_tRNA_strand)
    ...
    return complete_tRNA_strand, rna_template_strand, formatted_amino_acid_seq
...
def convert_rna_decorator_3_5(func): 
    ...
    """
       ...
       to print out the results: the complementary tRNA strand, the base-pairing representation and the amino
       acid sequence.

    Args:
        func ([str]): The return value of convert_rna_5_3: a tuple consisting of complementary_tRNA_strand
        rna_template_strand, and the amino acid sequence.
...
def convert_rna_3_5(rna_template_strand):
    ...
    """The convert_rna_3_5 function takes in a input mRNA strand that has a 3 to 5 directionality,
       and returns a complementary tRNA strand that has a 5 to 3 directionality. 
        
    Args:
        rna_template_strand (str): The single-stranded template mRNA strand.
